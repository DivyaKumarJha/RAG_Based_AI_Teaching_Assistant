...
for filename in os.listdir("jsons"):
    if filename.endswith(".json"):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            num_groups = (num_chunks + n - 1) // n  # Ceiling division to get number of groups
            ...
            os.makedirs("new_merged_jsons", exist_ok=True)  
            with open(os.path.join("new_merged_jsons", filename), 'w', encoding='utf-8') as json_file:
